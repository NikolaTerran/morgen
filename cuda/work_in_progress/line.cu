...
struct Array drawLine(struct Array arr, struct Edge ed, int color[3]){
	...
	cudaMalloc((void **)&d_x,edge_size);
	cudaMalloc((void **)&d_y,edge_size);
	cudaMalloc((void **)&d_x1,edge_size);
	cudaMalloc((void **)&d_y1,edge_size);
	cudaMalloc((void **)&d_r,size);
	cudaMalloc((void **)&d_g,size);
	cudaMalloc((void **)&d_b,size);

    cudaMemcpy(d_x,x,edge_size,cudaMemcpyHostToDevice);
    cudaMemcpy(d_y,y,edge_size,cudaMemcpyHostToDevice);
    cudaMemcpy(d_x1,x1,edge_size,cudaMemcpyHostToDevice);
    cudaMemcpy(d_y1,y1,edge_size,cudaMemcpyHostToDevice);

    //probably unnecessary
    cudaMemcpy(d_r,arr.r,size,cudaMemcpyHostToDevice);
    cudaMemcpy(d_g,arr.g,size,cudaMemcpyHostToDevice);
    cudaMemcpy(d_b,arr.b,size,cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(arr.r,d_r,size,cudaMemcpyDeviceToHost);
    cudaMemcpy(arr.g,d_g,size,cudaMemcpyDeviceToHost);
    cudaMemcpy(arr.b,d_b,size,cudaMemcpyDeviceToHost);
